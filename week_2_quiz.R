...
# Exercise 6
X <- matrix( 
  c(1,1,1,1,1,1,1,1,5,4,6,2,3,2,7,6,8,9,4,7,4,9,6,4), 
  nrow=8, 
  ncol=3)
print(X)
...
det(X %*% t(X)) # determinant is zero

# As the determinant is zero, we can not calculate inverse of X'X and proving each equivalence can be more or less hard.
solve(X %*% t(X)) # throws error
